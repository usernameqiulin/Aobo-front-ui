...
class PromotionMenu extends React.Component {
    ...
    _mouseEnterSub = (event) => {
        this.props.cancelTimeout('promotion')
    }
    ...
    render() {
        ...
        return (
            <div className={`menu-item has-submenu menu-item--animated hide-in-lite-mode hide-in-grouped-mode js-menu-promotion`}
                 onMouseEnter={this._mouseEnter}
                 onMouseLeave={this._mouseLeave}
            >
                <Link className="menu-link menu-uppercase js-menu-link" to="/promotion" onTouchStart={this._touchStart}
                ...
                <div className={`menu-submenu menu-promotion__submenu js-menu-sloped-submenu${this.state.isLayerExpanded ? ' menu-promotion__submenu--category-expanded' : ''}`}
...
export default translate()(PromotionMenu)