...
class LotteryMenu extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    _mouseEnterSub = (event) => {
        this.props.cancelTimeout('lottery')
    }
    ...
    render() {
        ...
        return (
            <div className={`menu-item has-submenu menu-item--animated hide-in-lite-mode js-menu-lottery`}
                 onMouseEnter={this._mouseEnter}
                 onMouseLeave={this._mouseLeave}
            >
                <Link className="menu-link menu-uppercase js-menu-link" to="/lottery" onTouchStart={this._touchStart}
                ...
                <div className={`menu-submenu menu-lottery__submenu js-menu-sloped-submenu${this.state.isLayerExpanded ? ' menu-lottery__submenu--category-expanded' : ''}`}
...
export default translate()(LotteryMenu)